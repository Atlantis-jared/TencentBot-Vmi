...
namespace winrt::impl
{
    ...
    template <typename D> auto consume_Windows_UI_Shell_IWindowTabManagerStatics<D>::GetForWindow(uint64_t windowId) const
    {
        ...
        if constexpr (!std::is_same_v<D, winrt::Windows::UI::Shell::IWindowTabManagerStatics>)
        {
            ...
            check_hresult(_winrt_abi_type->GetForWindow(windowId, &result));
        }
        else
        {
    ...
    struct produce<D, winrt::Windows::UI::Shell::IWindowTabManagerStatics> : produce_base<D, winrt::Windows::UI::Shell::IWindowTabManagerStatics>
    {
        int32_t __stdcall GetForWindow(uint64_t windowId, void** result) noexcept final try
        {
            clear_abi(result);
            typename D::abi_guard guard(this->shim());
            *result = detach_from<winrt::Windows::UI::Shell::WindowTabManager>(this->shim().GetForWindow(windowId));
            return 0;
        }
        catch (...) { return to_hresult(); }
...
WINRT_EXPORT namespace winrt::Windows::UI::Shell
{
    ...
    {
        return impl::call_factory<WindowTabManager, IWindowTabManagerStatics>([&](IWindowTabManagerStatics const& f) { return f.GetForWindow(windowId); });
    }
